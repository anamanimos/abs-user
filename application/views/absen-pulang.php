...
<input type="hidden" name="allow" value="true">
    <div class="row text-center" id="row-opening">
        <div class="col-12">
            ...
            <div id="allowAbsence">
                <h3 class="title">Absensi Pulang</h3>
                <span style="color:grey;font-size:0.9em">Absensi pulang bisa dilakukan mulai pukul <?= jamAbsen($session['start'])?> dan berakhir pukul <?= jamAbsen($session['end'])?> WIB.</span>
                <?php
    ...
    <div class="row text-center" id="row-sad">
        <div class="col-12">
            ...
            <div id="disableAbsence">
                <h3 class="title">Absensi Pulang Belum dibuka</h3>
